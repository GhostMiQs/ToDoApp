...
//Ciasteczka przeglądarkowe i przesyłanie zadań
function setDefaultState() {
    ...
    baseState[id] = {
        status: "new",
        id: id,
        title: "Ta strona używa 🍪 do śledzenia Twoich zadań"
    };
    syncState(baseState);
}
...
function addItem(text, status, id, noUpdate) {
    ...
    $(".form-control")
        .val("")
        .attr("placeholder", "✍️ Dodaj zadanie...");
    setTimeout(function () {
...
todayContainer.innerHTML = Word + n;
//
